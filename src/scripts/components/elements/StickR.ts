...
export class StickR extends BaseElement {
    ...
    private isMoveDown(r: number, point: number): boolean {
        ...
        switch (this._position) {
            ...
            case 2:
                ...
                if ((this._boardPlate.children[r + 2] as any).children[point].texture !== this._base ||
            ...
            case 4:
                ...
                if ((this._boardPlate.children[r] as any).children[point - 1].texture !== this._base ||
                    (this._boardPlate.children[r + 2] as any).children[point].texture !== this._base
                ) {
                    go = false;
                    return go;
                }
    ...
    private isMoveLeft(r: number, point: number): boolean {
        ...
        switch (this._position) {
            ...
            case 4:
                ...
                if ((this._boardPlate.children[r - 1] as any).children[point - 2].texture !== this._base ||
    ...
    private isMoveRight(r: number, point: number): boolean {
        ...
        switch (this._position) {
            case 1:
                if (point === this._boardPlate.matrixCol - this.elementHeight) {
                    go = false;
                    return go;
                }
                if ((this._boardPlate.children[r] as any).children[point + 2].texture !== this._base ||
            ...
            case 3:
                ...
                break;
            case 4:
                if (point === this._boardPlate.matrixCol - 1) {
                    go = false;
                    return go;
                }
                if ((this._boardPlate.children[r - 1] as any).children[point + 1].texture !== this._base ||
                    (this._boardPlate.children[r] as any).children[point + 1].texture !== this._base ||
                    (this._boardPlate.children[r + 1] as any).children[point + 1].texture !== this._base
                ) {
                    go = false;
    ...
    private isRotate(r: number, point: number): boolean {
        ...
        switch (this._position) {
            case 1:
                ...
                if ((this._boardPlate.children[r + 1].children?.at(point) as any).texture !== this._base ||
    ...
    private reDrawDown(r: number, point: number): void {
        switch (this._position) {
            ...
            case 2:
                ...
                (this._boardPlate.children[r + 1].children?.at(point) as any).texture = this._texture;
                (this._boardPlate.children[r + 2].children?.at(point) as any).texture = this._texture;
